...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2017 at 10:00 AM
...
INSERT INTO `adjustments` (`id`, `subject_id`, `class_id`, `teacher_id`, `date`, `slot_id`) VALUES
(1, 9, 9, 4, '2017-08-04', 5),
(2, 18, 1, 7, '2017-08-04', 1),
(3, 5, 9, 2, '2017-08-04', 3),
(4, 17, 1, 1, '2017-08-04', 2);
...
INSERT INTO `admins` (`id`, `login_id`, `email`, `name`, `address`, `phone`, `snap`, `created_at`) VALUES
(6, 10, 'hello@hmad.com', 'hello', 'asjdjas', '9876543210', 'admins/abc.jpeg', '2017-06-29 23:14:59');
...
INSERT INTO `attend` (`id`, `lecture_id`, `student_id`, `date`, `time`, `status`, `created_at`) VALUES
(1, 1, 1, '2017-07-04', '00:00:00', 'present', '2017-07-04 15:12:24'),
(2, 1, 1, '2017-07-05', '00:00:00', 'present', '2017-07-05 13:03:06');
...
INSERT INTO `attendance` (`id`, `emp_id`, `status`, `time`, `date`, `verify`, `created_at`) VALUES
(2, 1, 'present', '00:00:00', '2017-02-12', 1, '2017-02-21 16:27:24'),
(3, 1, 'present', '02:56:00', '2017-03-09', NULL, '2017-03-09 14:07:59'),
(4, 5, 'present', '09:00:00', '2017-06-22', NULL, '2017-06-22 17:21:57');
...
INSERT INTO `classes` (`id`, `course_id`, `semester`, `section`) VALUES
(1, 1, '1', 'A'),
(2, 1, '2', 'B'),
(3, 2, '1', 'A'),
(4, 2, '2', 'B'),
...
INSERT INTO `courses` (`id`, `name`, `branch`, `fee_details`) VALUES
(1, 'BTECH', 'ME', '12345'),
(2, 'BTECH', 'ECE', '123'),
(4, 'BTECH ', 'CSE', '123'),
(6, 'BTECH', 'IT', '123');
...
INSERT INTO `daily_attendance` (`id`, `student_id`, `date`, `status`, `marked_at`) VALUES
(4, 1, '2017-07-15', 'present', '2017-07-15 15:43:04');
...
(2, 'ACCOUNTS', 'MS. SUSHMA'),
(7, 'HR', 'MS. CHARITA'),
(8, 'STUDENTS', 'MS. RANJANA'),
(9, 'CSE', 'MS. KAKKAR'),
(10, 'ECE', 'MS. POOJA'),
(11, 'ME', 'DR. SETHI');
...
INSERT INTO `fee` (`id`, `roll_number`, `course_id`, `amount`, `date_of_receipt`, `fee_taker`, `fee_type`) VALUES
(2, 1122355, 1, '1100', '2017-08-23 12:11:35', 1, 'monthly'),
(3, 1122355, 1, '1500', '2017-08-31 15:58:36', 1, 'monthly'),
(4, 1122355, 1, '1500', '2017-08-31 15:59:11', 1, 'monthly'),
(5, 1122355, 1, '1500', '2017-08-31 15:59:53', 1, 'monthly');
...
INSERT INTO `lectures` (`id`, `subject_id`, `class_id`, `teacher_id`, `day`, `slot_id`) VALUES
(3, 7, 9, 1, 'friday', '4'),
(4, 6, 9, 2, 'friday', '2'),
(5, 5, 9, 3, 'friday', '3'),
(6, 8, 9, 1, 'friday', '4'),
...
INSERT INTO `rights` (`id`, `emp_id`, `ir`, `vr`, `ur`, `dr`) VALUES
(7, 10, 1, 1, 1, 1);
...
INSERT INTO `students` (`id`, `class_id`, `login_id`, `roll_number`, `f_name`, `l_name`, `m_name`, `gender`, `email`, `address`, `state`, `city`, `pincode`, `dob`, `phone`, `mother_name`, `father_name`, `parents_contact`, `qualification`, `joining_date`, `photo`, `full_fee`, `fee_paid`, `due_date`) VALUES
(2, 1, 18, '1122355', 'Ram', 'Kumar', '', 'male', 'ram_kumar@gmail.com', '### ## #', '25', '906', '#####', '2010-10-30', '9876543210', 'Abc', 'Xyz', '9876543210', '10', '2009-08-29', 'students/ram_kumar.jpeg', '12345', '4500', '2017-12-01');
...
INSERT INTO `tasks` (`id`, `cid`, `title`, `description`, `assigned_date`, `deadline`, `priority`, `assigned_by`, `assigned_to`, `viewed`) VALUES
(1, 3, 'ads', 'asbndbsanb adbas', '2017-02-19 22:46:41', '2017-01-01', 'low', 1, 3, 1),
(2, 3, 'ads', 'asbndbsanb adbas', '2017-02-19 22:46:41', '2017-01-01', 'low', 1, 4, 1),
(3, 3, 'Get this done', 'Get this done', '2017-03-09 14:08:58', '2017-03-10', 'high', 1, 5, NULL),
(4, 3, 'sadsa', 'sadsa', '2017-03-09 14:18:15', '2016-12-29', 'medium', 1, 3, NULL);
...
INSERT INTO `teachers` (`id`, `dept_id`, `des_id`, `login_id`, `firstname`, `lastname`, `email`, `gender`, `phone`, `photo`, `dob`, `joining_date`, `address`, `state`, `city`, `pincode`, `qualification`, `experience`, `salary`) VALUES
(1, 9, 5, 2, 'Ram', 'Kumar', 'ram_kumar@gmail.com', 'MALE', '9876543210', 'am_kumar.png', '2014-12-31', '2014-12-31 00:00:00', 'dknasndka', '27', '954', '319382', 'btech', '3', '213211'),
(2, 9, 5, 12, 'Shyam', 'Mishra', 'shyam@gmail.com', 'MALE', '9876543210', 'efault.jpg', '1987-07-20', '1987-07-20 00:00:00', 'ac', '5', '187', '123545', 'Btech', '3', '31000'),
(3, 9, 5, 13, 'Ratna ', 'Pathak', 'ratna@gmail.com', 'FEMALE', '9876543210', 'teachers/default.jpg', '2004-08-31', '2011-12-31 00:00:00', '##', '27', '954', '#####', 'BTECH', '3', '31000'),
(4, 9, 5, 14, 'Mala', 'Gupta', 'mala@gmail.com', 'FEMALE', '9876543210', 'teachers/default.jpg', '2009-08-31', '2012-12-31 00:00:00', '###', '26', '926', '#####', 'BTECH', '3', '31000'),
(5, 9, 5, 15, 'Manpreet', 'Kaur', 'manpreet@gmail.com', 'FEMALE', '8797989710', 'teachers/default.jpg', '2010-09-28', '2011-10-30 00:00:00', '###', '27', '954', '#####', 'btech', '3', '31000'),
(6, 9, 5, 16, 'Manveer', 'Singh', 'manveer@gmail.com', 'MALE', '9878980055', 'teachers/default.jpg', '2007-09-29', '2010-08-29 00:00:00', '##', '5', '186', '#####', 'BTECH', '3', '31000'),
(7, 9, 5, 17, 'Ravi', 'Shahtri', 'ravi@gmail.com', 'MALE', '9876543210', 'teachers/default.jpg', '2010-09-29', '2009-09-28 00:00:00', '###', '25', '906', '#####', 'BTECH', '3', '31000');
...
--
-- Dumping data for table `teacher_attend`
--

INSERT INTO `teacher_attend` (`id`, `teacher_id`, `date`, `status`, `marked_on`) VALUES
(348604, 5, '2017-08-04', 'absent', '2017-08-04 12:49:56'),
(348603, 3, '2017-08-04', 'absent', '2017-08-04 12:49:56'),
(348594, 7, '2017-08-04', 'present', '2017-08-04 12:13:49'),
(348593, 2, '2017-08-04', 'present', '2017-08-04 12:12:56'),
(348592, 1, '2017-08-04', 'present', '2017-08-04 12:12:47'),
(348591, 6, '2017-08-04', 'present', '2017-08-04 12:12:21'),
(348590, 4, '2017-08-04', 'present', '2017-08-04 12:12:14'),
(348589, 6, '2017-08-01', 'absent', '2017-08-01 11:37:04'),
(348588, 2, '2017-08-01', 'absent', '2017-08-01 11:37:04'),
(348557, 7, '2017-08-01', 'present', '2017-08-01 11:14:09'),
(348556, 3, '2017-08-01', 'present', '2017-08-01 11:13:59'),
(348555, 5, '2017-08-01', 'present', '2017-08-01 11:12:52'),
(348554, 1, '2017-08-01', 'present', '2017-08-01 11:12:41'),
(348553, 4, '2017-08-01', 'present', '2017-08-01 11:12:04');
...
INSERT INTO `user_login` (`id`, `username`, `password`, `type`, `created_at`) VALUES
(1, 'admin', 'admin', 'teacher', '2017-06-28 22:18:46'),
(2, 'ram_kumar', 'hello', 'teacher', '2017-06-29 11:13:53'),
(12, 'shyam_mishra', 'shyam', 'teacher', '2017-07-10 22:20:25'),
(11, 'ajay_singh', 'ajay_singh', 'student', '2017-07-02 16:56:39'),
(10, 'abc', 'abc', 'admin', '2017-06-29 23:14:59'),
(13, 'ratna_pathak', 'ratna', 'teacher', '2017-07-31 14:42:30'),
(14, 'mala', 'mala', 'teacher', '2017-07-31 14:43:56'),
(15, 'manpreet', 'manpreet', 'teacher', '2017-07-31 14:45:11'),
(16, 'manveer', 'manveer', 'teacher', '2017-07-31 14:46:44'),
(17, 'RAVI', 'RAVI', 'teacher', '2017-07-31 14:55:39'),
(18, 'ram_kumar', 'ram_kumar', 'student', '2017-08-23 12:07:12');
