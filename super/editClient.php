							...
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  ...
								  <input type="hidden" value="<?=$e_pass?>" name="e_pass"></input>
								</div>
							  </div>
							  <div class="control-group">
							  ...
							  <div class="control-group">
								<label class="control-label" for="e_address">Employee's Address</label>
								<div class="controls">
								  <input class="input-xlarge focused" style="height:28;" name="e_address" id="e_address" type="text" value="<?php echo $e_address;?>" required>
								</div>
							  </div>
							</div>  
