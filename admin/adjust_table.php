			...
			<div class="row-fluid sortable">
				<div class="span9 tasks-con">
					...
					<div class="box-content">
						...
						?>
						<form action="adjust_table.php" method="post">
						...
						<tr>
						 <td align="center"> ##### </td>
						 <?php
						 	$q_lec="select * from adjustments where teacher_id='$t_id'";
						 	...
						 	<?php 
					 			...
					 			foreach($t as $slot){
						 			...
						 			//while($lec){
						 				...
						 				$date_day=strtolower(date('l', strtotime($lec['date'])));
						 				if($c_time===$time && $date_day===strtolower($day)){
						 	?>
