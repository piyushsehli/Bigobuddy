						  ...
						  ?>
							<tr>
								...
								<?php
										...
										//if($_SESSION['vr']==1){
											echo "<a class='btn btn-success' href='viewteacher.php?id=$id'><i class='icon-zoom-in icon-white'></i>View</a>&nbsp;";
										//}
										//if($_SESSION['ur']==1){
											echo "<a class='btn btn-info' href='editteacher.php?id=$id'><i class='icon-edit icon-white'></i>Edit</a>&nbsp;";
										//}
										//if($_SESSION['dr']==1){
											echo "<a class='btn btn-danger' href='delteacher.php?id=$id'><i class='icon-trash icon-white'></i>Delete</a>";
										//}
