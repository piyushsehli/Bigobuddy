...
<?php require_once("headincludes.php"); ?>
	<script type="text/javascript">
		...
		function reload(form){
			...
			self.location='attendancereport.php?month=' + month_val + '&year=' + year_val + '&enid=' + enid ; // reload the page
		}
	</script>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php
						...
						?>
							<option value='<?php echo $id;?>' <?php if($id==$enid){echo 'selected';}?> ><?php echo $roll_number.' - '.$f_name.' '.$l_name;?></option>
						<?php
							}
						echo "</select>";
						...
						echo "<th>Sun</th><th>Mon</th><th>Tue</th><th>Wed</th><th>Thu</th><th>Fri</th><th>Sat</th></tr><tr>";
							for($i=1;$i<=$no_of_days;$i++){
								...
								if(isset($_GET['enid'])){
									...
									$query = "select * from daily_attendance where date='$attdate' and student_id='$enid'";
