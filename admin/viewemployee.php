						  ...
						  <ul class="dashboard-list">
							  <legend><h3 style="color:red; margin-top:20px">Login Details</h3></legend>
								...
								<li>
							  	...
							  	<legend><h3 style="color:red; margin-top:20px">Office Details</h3></legend>
								...
								<li>
										...
										<a class='btn btn-success' href='employee.php' style="margin-top:20px"><i class='icon-zoom-in icon-white'></i>Back</a>
