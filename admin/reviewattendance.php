...
<script type="text/javascript">
		...
		function reload(form){
			...
			self.location='reviewattendance.php?month=' + month_val + '&year=' + year_val; // reload the page
		}
	</script>
	...
	<!-- topbar ends -->
		<div class="container-fluid">
					...
					<?php
						...
						echo "<th>Sun</th><th>Mon</th><th>Tue</th><th>Wed</th><th>Thu</th><th>Fri</th><th>Sat</th></tr><tr>";
							for($i=1;$i<=$no_of_days;$i++){
								...
								//var_dump($pv);
								$date=$year."-".$month."-".$i;
								echo $adj."<td class='$tdclass'><a href='reviewattendance.php?date=$date'>$i</a></td>";
								$adj='';
								$j ++;
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>Employees Attendance List</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php
								...
								$obj=new task;
								$query = "select * from attendance where `date`='$chosenDate'";
						  ...
						  ?>
							...
							<tr>
							 <form id="form<?php echo $inc;?>">
								<input type="hidden" value="<?php echo $id;?>" name="emp_id"></input>
								<input type="hidden" value="<?php echo $chosenDate;?>" name="date"></input>
								<td class="center"><?php echo $id; ?></td>
								
								<td class="center"><?php echo $obj->getValue("employee","username", $row['emp_id']);  ?></td>
								
								<td class="center"><?php echo $obj->getValue("employee","email", $row['emp_id']);  ?></td>
								...
								<td>
									<input type="time" name="time" value="<?php echo $row['time'];?>"></input>
								</td>
