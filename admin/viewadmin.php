						...
						<div class="box-content">
						  ...
						  <ul class="dashboard-list">
								...
								<li>
										...
										<?php echo "<a class='btn btn-info' href='editadmin.php?id=$id'><i class='icon-edit icon-white'></i>Edit</a>&nbsp;";
												echo "<a onclick='return confirm(\"Are you sure to delete this record?\");' class='btn btn-danger' href='deladmin.php?id=$id'><i class='icon-trash icon-white'></i>Delete</a>";
										 ?><br>
								</li>
								</ul>
						    </div>
