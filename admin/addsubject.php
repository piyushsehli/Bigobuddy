	...
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					<li>
						<a href="subject.php" style="text-decoration:none;">
							<img src="img/add.png" />
							&nbsp;
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> New Subject Form</h2>
						<div class="box-icon">
						...
						<form class="form-horizontal" name="newclient" method="post" enctype="multipart/form-data">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input name="subject" class="input-xlarge focused" id="focusedInput" type="text" value="">
								</div>
							  </div>
