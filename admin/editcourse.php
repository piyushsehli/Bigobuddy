						...
						<form class="form-horizontal" name="newclient" method="post" enctype="multipart/form-data">
							...
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input name="course_name" class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $name; ?>" />
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input name="branch" class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $branch; ?>" />
								</div>
							  </div>							  
							  <div class="control-group">
								<label class="control-label" for="focusedInput">Course Fee</label>
								<div class="controls">
								  <input name="fee" class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $fee_details; ?>" />
								</div>
							  </div>	
