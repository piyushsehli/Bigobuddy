			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Designation</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<span style="color:green;font-size:16px;">
							<?php
								if($done==1)
								{
									echo "Main Designation updated successfully.";
								}
							?>
						</span>
						<form class="form-horizontal" name="newclient" method="post" enctype="multipart/form-data">
							...
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input name="position" class="input-xlarge focused" id="focusedInput" type="text" value="<?php echo $position; ?>" />
								</div>
							  </div>
